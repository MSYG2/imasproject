 ...
 */
public class HarvesterGlassCoordinatorAgent extends ImasAgent {
    ...
    public HarvesterGlassCoordinatorAgent() {
        super(AgentType.HARVESTER_GLASS_COORDINATOR);
    }
    ...
    protected void setup() {
        ...
        sd1.setType(AgentType.HARVESTER_GLASS_COORDINATOR.toString());
