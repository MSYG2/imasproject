...
/**
 * The Harvester Plastic Coordinator agent. 
 * TODO: Coordinating Harvester Agents to harvest paper garbage,
 * and communicate with Coordinator Agent.
 */
public class HarvesterPlasticCoordinatorAgent extends ImasAgent {
    ...
    protected void setup() {
        ...
        sd1.setType(AgentType.HARVESTER_PLASTIC_COORDINATOR.toString());
